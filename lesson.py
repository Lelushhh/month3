...
def main(page: ft.Page):
    ...
    def on_button_click(_):
        ...
        if len(greeting_history) > 5:
            ...
            history_text.value = f"История приветствий:/n" + "/n".join(greeting_history)
    ...
    # page.add(greeting_text, name_input, button_text, greeting_text, clear_button)

    viev_greeting_text = ft.Row([greeting_text], alignment=ft.MainAxisAlignment.CENTER)
    page.add(viev_greeting_text, ft.Row([name_input, button_elevated, clear_button]), history_text)
